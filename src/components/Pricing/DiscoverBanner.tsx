      ...
      <div className="relative mx-auto max-w-6xl overflow-hidden rounded-3xl bg-white/70 shadow-md backdrop-blur">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center p-6 md:p-10">
          <div className="relative z-10">
            ...
            <h1 className="mt-4 text-3xl md:text-5xl font-semibold leading-tight tracking-tight text-slate-900">
              Discover Top Pricing <br />& Deals
            </h1>

            <p className="mt-4 text-slate-600 text-md max-w-xl">
              Our fees scale based on the number of registered states,
              reflecting the complexity of multi-state management. All plans
              include up to 20,000 orders per month, with no hidden charges—pay
          ...
          <div className="relative flex h-[260px] sm:h-[300px] md:h-[340px] items-center justify-center">
            ...
            <div className="relative flex h-full w-full max-w-[260px] sm:max-w-[300px] md:max-w-[340px] items-end justify-center">
              ...
              <div className="hidden sm:block absolute inset-y-10 -right-4 h-80 w-[220px] rounded-2xl  bg-white/70 shadow-lg" />
