...
const SectionHeader: React.FC = () => (
  <h2 className="px-4 md:px-0 mx-auto max-w-3xl text-center text-3xl md:text-5xl font-medium tracking-tight leading-tight text-slate-900">
    <span className="text-[#3dd3ce]">Precision</span> Driven Tax{" "}
    <span className="text-[#ffc52f]">Advisory</span> for
    <br />
    Forward Thinking <span className="text-[#3dd3ce]">Businesses</span>
  </h2>
);
        ...
        <div className="border-t border-slate-200 p-4 md:p-6 min-h-0">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 text-slate-700 font-medium">
              ...
              Comparison of screen resolution and refresh rate between Switch 2
              and OLED models
            </div>
