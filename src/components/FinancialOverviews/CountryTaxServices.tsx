...
const CountryTaxServices: React.FC = () => {
  ...
  */}
          ...
          <div className="col-span-2 rounded-2xl bg-[#3DD3CE]/20 ring-slate-200 p-16">
            <div className="text-sm text-slate-700">{active.subtitle}</div>
            <hr className="my-4" />
            ...
            <button className="mt-6 rounded-md bg-teal-500 text-white text-sm font-semibold px-4 py-2 hover:bg-teal-600 transition">
              Choose Plan
            </button>
          </div>
        </div>
